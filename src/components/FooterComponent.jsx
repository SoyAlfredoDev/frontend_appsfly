        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              La plataforma todo en uno para gestionar tu negocio. Simple,
              potente y escalable.
            </p>
          </div>
          ...
          {/* Product Column */}
          <div>
            <h4 className="font-bold text-[#021f41] mb-4 font-display">
              Producto
            </h4>
            <ul className="space-y-2 text-sm text-gray-500">
              <li>
                <a href="#" className="hover:text-[#01c676] transition-colors">
                  Características
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              <li>
                <a
                  href="/about-us"
                  className="hover:text-[#01c676] transition-colors"
                >
                  Nosotros
                </a>
              </li>
