...
import ClickableLandingImage from '../../components/web/ClickableLandingImage.jsx';

const SCREENSHOTS = [
    {
        src: '/hero/imagen-hero-01.png',
        alt: 'Dashboard de cierre diario en AppsFly',
        label: 'Cierre diario',
        description: 'Métricas, recaudación y ventas por hora de un vistazo',
    },
    {
        src: '/hero/imagen-hero-02.png',
        alt: 'Tabla de ventas en AppsFly',
        label: 'Historial de ventas',
        description: 'Consulta y gestiona todas tus ventas realizadas',
    },
    {
        src: '/hero/imagen-hero-03.png',
        alt: 'Registro de nueva venta en AppsFly',
        label: 'Registrar venta',
        description: 'Carga productos, cobra y finaliza en segundos',
    },
];
...
export default function HeroScreenshotGallery() {
    ...
    return (
        <div className="relative w-full max-w-xl mx-auto lg:max-w-none lg:mx-0">
                ...
                <div className="mt-4 grid grid-cols-3 gap-2 sm:gap-3">
                    {SCREENSHOTS.map((shot, index) => (
                        <button
                            ...
                            type="button"
                            onClick={() => goTo(index)}
                            aria-label={`Ver captura: ${shot.label}`}
                            className={`
            ...
            <div className="mt-5 flex items-center justify-center lg:justify-start gap-2 rounded-full border border-slate-200/80 bg-white/90 px-4 py-2 text-xs font-medium text-slate-600 shadow-sm backdrop-blur-sm w-fit mx-auto lg:mx-0">
