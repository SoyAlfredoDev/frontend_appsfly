...
import { FaEye, FaPlus, FaShoppingBag } from "react-icons/fa";
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: ({ getValue }) => {
        ...
        if (value === "PENDING") colorClass = "bg-amber-100 text-amber-700";
      ...
      cell: ({ row }) => (
        <div className="flex items-center justify-center gap-1">
          <button
            ...
            onClick={() => navigate(`/purchase/view/${row.original.purchaseId}`)}
            title="Ver detalle"
          >
            <FaEye />
          </button>
